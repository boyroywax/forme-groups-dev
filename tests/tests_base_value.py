...
class TestBaseValue(unittest.TestCase):
    ...
    def test_init_with_list(self):
        ...
        self.assertRaises(TypeError, BaseValue, [1, 2, 3])
    ...
    def test_init_with_dict(self):
        try:
            ...
            self.assertTrue(True)
        self.assertRaises(TypeError, BaseValue, {"a": 1, "b": 2, "c": 3})
    ...
    def test_init_with_frozenset(self):
        try:
            ...
            self.assertTrue(True)
        self.assertRaises(TypeError, BaseValue, frozenset({1, 2, 3}))
    ...
    def test_init_with_BaseValue(self):
        try:
            ...
            self.assertTrue(True)
        self.assertRaises(TypeError, BaseValue, BaseValue(1))
    ...
    def test_base_value_peek_value_with_containers(self):
        self.assertRaises(TypeError, BaseValue._peek_value, [1, 2, 3])
        self.assertRaises(TypeError, BaseValue._peek_value, {1, 2, 3})
        self.assertRaises(TypeError, BaseValue._peek_value, (1, 2, 3))
        self.assertRaises(TypeError, BaseValue._peek_value, {"a": 1, "b": 2, "c": 3})
        self.assertRaises(TypeError, BaseValue._peek_value, frozenset({1, 2, 3}))
    ...
    def test_base_value_force_type_with_none_fails(self):
        value = BaseValue(None)
        self.assertRaises(TypeError, BaseValue._force_type, value, "int")
    ...
    def test_base_value_force_type_with_float_to_bytes(self):
        value = BaseValue(1.6)
        self.assertRaises(TypeError, BaseValue._force_type, value, "bytes")
