...
class TestBaseValue(unittest.TestCase):
    ...
    #     # the re
    #     self.assertEqual(value._hash_repr(), '5176a0db25fa8911b84f16b90d6c02d56d0c983122bc26fd137713aa0ede123f')
    #     self.assertEqual(value._hash_package().root(), "6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b")
    #     self.assertEqual(value._hash_package().levels, (('6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b', ), ))
